...
export default function ExperiencePage() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Header */}
      <section className="bg-[var(--color-rtc-navy)] text-white py-20 border-b-4 border-[var(--color-rtc-green)]">
      ...
      {/* Disclaimer */}
      <section className="py-8 bg-[var(--color-rtc-light)] border-b border-gray-200">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-4xl space-y-24">
          ...
          <div>
            ...
            <div className="bg-white border-l-4 border-[var(--color-rtc-blue)] pl-6 py-2">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-2 list-disc list-inside text-gray-600">
          ...
          <div>
            ...
            <div className="bg-white border-l-4 border-[var(--color-rtc-green)] pl-6 py-2">
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
          ...
          <div>
            ...
            <div className="bg-white border-l-4 border-[var(--color-rtc-navy-dark)] pl-6 py-2">
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
          ...
          <div>
            ...
            <div className="bg-white border-l-4 border-gray-400 pl-6 py-2">
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
